...
BEGIN
        ...
        BEGIN TRY
                ...
                SELECT  cst_id,
                        ...
                        END AS cst_gndr,
                        cst_create_date
                FROM (SELECT *, ROW_NUMBER() OVER(PARTITION BY cst_id ORDER BY cst_create_date) AS row_number FROM bronze.crm_cust_info WHERE cst_id IS NOT NULL) AS sb
                WHERE sb.row_number = 1;
